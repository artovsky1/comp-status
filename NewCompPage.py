...
class NewCompPage(CTkFrame):
    ...
    def __init__(self, master):
        ...
        def sql_insert():
            ...
            conn.execute(INSERT_COMPONENT, values)
        ...
        self.description_py = CTkOptionMenu(self, values=['2D fleece', '3D fleece', 'PE insert', 'Wire',
                                                          'Frame', 'Clip',
        ...
        self.project_py = CTkOptionMenu(self, values=['Porsche G3', 'Opel OV', 'CDPO', 'Volvo GPA'],
                                        state='readonly')
